...
class showCollectionViewController: UICollectionViewController {
    ...
    */
        ...
        else
        {
            ...
            for item in labels.enumerated(){
                if item.element==select{
                    showlist = ImageData[item.offset]
                    break
                }
            }
        }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "show", for: indexPath) as! CollectionViewCell
        // Configure the cell
        
        cell.preview.image=showlist[indexPath.row].image
        return cell
    }
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
